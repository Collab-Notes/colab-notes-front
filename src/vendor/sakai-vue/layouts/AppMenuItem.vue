...
import { useRoute } from "#app"; // Cambia la importación para usar el router de Nuxt
...
const route = useRoute(); // Usa el router de Nuxt
...
function checkActiveRoute(item) {
  // Modificado para trabajar con Nuxt
  return route && item.to && route.path === item.to;
}
</script>
